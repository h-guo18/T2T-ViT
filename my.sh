...
CUDA_VISIBLE_DEVICES=0,1 ./distributed_train.sh 2 data/ --model t2t_vit_7 -b 1024 --lr 1e-2 --weight-decay .03   --img-size 224 --resume output/train/linformer-t2t_vit_7-224/checkpoint-300.pth.tar
